...
from app.models.cbcf.helpers.cb_helper_function import get_text_distance, cb_manipulate_text
...
class ContTrain(object):
    ...
    def fit(self):
        ...
        last_n_weeks = ConfigTraining.CB_REC_PARAM['max_product_age_weeks']
