...
def avg_jaccard_at_k(actual: list, predicted: list, k=10):
    """
    Computes the mean jaccard at k.
    ...
    """
    return np.mean([jaccard_at_k(a, p, k) for a, p in zip(actual, predicted)])


def recall_at_k(actual: list, predicted: list, k=10):
...
def avg_recall_at_k(actual: list, predicted: list, k=10):
    """
    ...
    score : double
            The mean recall at k over the input lists
    """
    return np.round(np.mean([recall_at_k(a, p, k) for a, p in zip(actual, predicted)]), 2)


def precision_at_k(actual: list, predicted: list, k=10):
...
def avg_precision_at_k(actual: list, predicted: list, k=10):
    """
    ...
    """
    return np.round(np.mean([precision_at_k(a, p, k) for a, p in zip(actual, predicted)]), 2)


def f1_at_k(actual: list, predicted: list, k):
...
def avg_f1_at_k(actual: list, predicted: list, k=10):
    """
    ...
    score : double
            The mean precision at k over the input lists
    """
    return np.round(np.mean([f1_at_k(a, p, k) for a, p in zip(actual, predicted)]), 2)
